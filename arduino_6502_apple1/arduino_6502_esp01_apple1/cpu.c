...
#define esp8266
#ifndef esp8266
#include <avr/pgmspace.h> //comment for esp8266
#else
#define PROGMEM /* PROGMEM commented for esp8266 */
#endif
...
#ifdef esp8266
    if (BIOSaddr < 0x100) return(BIOS[BIOSaddr]);
#else    
